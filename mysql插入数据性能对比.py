...
def get_table():
    FILE_NAME = '/home/fred/users.xls2'
    date = xlrd.open_workbook(FILE_NAME)
    table = date.sheets()[0]
    return table
...
# 连接数据库
conn = MySQLdb.connect(host="127.0.0.1", port=3306, user="root", passwd="123456", db="pycharmdatabases")
cur = conn.cursor()
